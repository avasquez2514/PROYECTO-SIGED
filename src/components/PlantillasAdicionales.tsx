...
      {/* Modal para editar plantillas (CÓDIGO CORREGIDO) */}
      <Modal
        isOpen={modalOpen}
        onClose={() => setModalOpen(false)}
        // 🟢 PROPIEDADES AÑADIDAS PARA CUMPLIR CON MODALPROPS:
        title={"Modificar Plantilla"}
        showSaveButton={true}
        onSave={guardarPlantillaModal} // 🟢 Conectado a la función de guardado
      >
        {/* 🛑 Eliminamos el <h2>Modificar Plantilla</h2> */}
...
          {/* 🛑 ELIMINAMOS EL BOTÓN DE GUARDAR DUPLICADO:
          <button onClick={guardarPlantillaModal} className="modal-save-button">
            Actualizar
          </button>
            */}

          {/* Botón para eliminar plantilla (Este sí se mantiene) */}
          <button
            onClick={() => {
